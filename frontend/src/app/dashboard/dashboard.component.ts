...
@Component({
  ...
  imports: [UserFormComponent, CommonModule, MatDialogModule, MatButtonModule, ConfirmationDialogComponent],  // Import necessary Angular Material modules
})
  ...
  fetchUsers() {
    ...
    this.userService.getUsers().subscribe(
      ...
      (error: any) => {
        ...
        this.isLoading = false;
        this.errorMessage = 'Une erreur est survenue lors de la récupération des utilisateurs.';  // Set error message
      }
    );
  }
      ...
      if (result === 'confirm') {
        this.userService.deleteUser(userId).subscribe(
          ...
          (error: any) => {
            ...
            this.errorMessage = 'Une erreur est survenue lors de la suppression de l\'utilisateur.';  // Set error message
          }
        );
      }
    });
